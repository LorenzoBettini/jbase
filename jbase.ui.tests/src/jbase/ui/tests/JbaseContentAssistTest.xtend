...
class JbaseContentAssistTest extends AbstractContentAssistTest {
	...
	@Test def void testFinalParam() {
		newBuilder.append("op m(fi").assertProposal("final")
	}
	...
	@Test def void testArgsProposedInBlock() {
		newBuilder.append("{ a").assertProposal("args")
	}
	...
	@Test def void testVariableReferenceInVariableDeclarationInBlock() {
		newBuilder.append("int myVar = 0; { int i = ").assertProposal("myVar")
	}

	@Test def void testVariableReferenceInVariableDeclarationInBlock2() {
		newBuilder.append("int myVar = 0; { int i = <|>; }").assertProposalAtCursor("myVar")
	}

	@Test def void testVariableReferenceInAssignmentInMethod() {
		newBuilder.append("op foo() { int myVar = 0; myVar = my").assertProposal("myVar")
	}

	@Test def void testVariableReferenceInAssignmentInMethod2() {
		newBuilder.append("op foo() { int myVar = 0; myVar = ").assertProposal("myVar")
	}

	@Test def void testVariableReferenceInVariableDeclarationInMethod() {
		newBuilder.append("op foo() { int myVar = 0; int i = my").assertProposal("myVar")
	}

	@Test def void testVariableReferenceInVariableDeclarationInMethod2() {
		newBuilder.append("op foo() { int myVar = 0; int i = ").assertProposal("myVar")
	}

	@Test def void testMethodCallProposal() {
		newBuilder.append("op myMeth() { return 0; } my").assertProposal("myMeth")
	}

	@Test def void testMethodCallProposalInBlock() {
		newBuilder.append("op myMeth() { return 0; } { my").assertProposal("myMeth")
	}

	@Test def void testMethodCallProposalInExpressio() {
		newBuilder.append("op myMeth() { return 0; } while(my").assertProposal("myMeth")
	}

	@Test def void testMemberFeatureCallProposalInMethod() {
		newBuilder.append('op m() { String s = ""; s.to').assertProposal("toString")
	}

	@Test def void testMemberFeatureCallProposalInBlock() {
	...
	@Test def void testCastType() {
		newBuilder.append("(LinkedL").assertProposal("java.util.LinkedList")
	}
