 ...
 *
 */
public class JbaseTestlanguageInjectorProviderCustom extends JbaseTestlanguageInjectorProvider {

	public Injector internalCreateInjector() {
		return new JbaseTestlanguageStandaloneSetup() {
			@Override
			public Injector createInjector() {
				return Guice.createInjector(new JbaseTestlanguageRuntimeModule() {
					@Override
					public ClassLoader bindClassLoaderToInstance() {
						return JbaseTestlanguageInjectorProviderCustom.class.getClassLoader();
					}
