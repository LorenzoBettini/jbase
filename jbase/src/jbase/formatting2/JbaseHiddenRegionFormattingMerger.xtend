 ...
 * 
 * This probably happens because our custom member feature call embeds a XJArrayAccessExpression
 * which is created on the fly.
 * 
 * @author Lorenzo Bettini
 */
class JbaseHiddenRegionFormattingMerger extends HiddenRegionFormattingMerger {
