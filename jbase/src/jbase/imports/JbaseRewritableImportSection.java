...
public class JbaseRewritableImportSection extends RewritableImportSection {
	 ...
	 *
	 */
	public static class JbaseRewritableImportSectionFactory extends Factory {
		...
		public RewritableImportSection parse(XtextResource resource) {
			return new JbaseRewritableImportSection(resource, importsConfiguration,
		...
		public RewritableImportSection createNewEmpty(XtextResource resource) {
			RewritableImportSection rewritableImportSection = new JbaseRewritableImportSection(resource, importsConfiguration, null, whitespaceInformationProvider
	 ...
	 * @param nameConverter
	 */
	public JbaseRewritableImportSection(XtextResource resource,
