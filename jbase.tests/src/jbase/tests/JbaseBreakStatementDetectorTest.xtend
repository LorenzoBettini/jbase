...
class JbaseBreakStatementDetectorTest extends JbaseAbstractTest {

	static class JbaseBreakStatementDetectorCustom extends JbaseBreakStatementDetector {
	...
	val detector = new JbaseBreakStatementDetectorCustom
